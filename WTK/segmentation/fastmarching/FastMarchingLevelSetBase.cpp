 ...
 *
 ***********************************/
FastMarchingLevelSetBase::FastMarchingLevelSetBase()
{
 ...
 ***********************************/
void
FastMarchingLevelSetBase::LoadInputImage( const char * filename )
{
    if( !filename ) {
        return;
    }
 ...
 *
 ***********************************/
void FastMarchingLevelSetBase::SaveOutputImage( const char * filename )
{
    if( !filename ) {
        return;
    }
 ...
 *
 ***********************************/
void FastMarchingLevelSetBase::ClearSeeds()
{
 ...
 *
 ***********************************/
void FastMarchingLevelSetBase::AddSeed( const IndexType & seedPosition  )
{
    // setup trial points
    NodeType node;
 ...
 *
 ***********************************/
void FastMarchingLevelSetBase::ComputeGradientMagnitude( void )
{
 ...
 *
 ***********************************/
void FastMarchingLevelSetBase::ComputeEdgePotential( void )
{
 ...
 *
 ***********************************************************/
void FastMarchingLevelSetBase::SetStoppingValue( double value )
{
 ...
 *
 ***********************************/
void FastMarchingLevelSetBase::RunFastMarching( void )
{
 ...
 *
 ***********************************/
void FastMarchingLevelSetBase::Stop( void )
{
