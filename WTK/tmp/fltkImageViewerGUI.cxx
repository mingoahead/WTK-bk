...
Fl_Double_Window* fltkImageViewerGUI::CreateGUI() {
  { iviewWindow = new Fl_Double_Window(295, 400);
    ...
    { sliceNumberSlider = new Fl_Value_Slider(270, 25, 20, 250, "Slice");
      sliceNumberSlider->type(4);
      sliceNumberSlider->labelsize(10);
      sliceNumberSlider->step(1);
      sliceNumberSlider->textsize(9);
    ...
    { intensityWindowingMinSlider = new Fl_Value_Slider(0, 360, 300, 20);
      intensityWindowingMinSlider->type(3);
      intensityWindowingMinSlider->selection_color(FL_GRAY0);
    ...
    { intensityWindowingMaxSlider = new Fl_Value_Slider(0, 380, 300, 20);
      intensityWindowingMaxSlider->type(3);
      intensityWindowingMaxSlider->color((Fl_Color)55);
      intensityWindowingMaxSlider->selection_color(FL_DARK1);
    ...
    iviewWindow->end();
    iviewWindow->resizable(iviewWindow);
