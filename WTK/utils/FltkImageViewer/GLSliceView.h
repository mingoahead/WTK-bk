...
class GLSliceView :
    public SliceView<ImagePixelType>, public Fl_Gl_Window
{
public:
...
template <class ImagePixelType, class OverlayPixelType>
GLSliceView<ImagePixelType, OverlayPixelType>::GLSliceView(int lx, int ly, int lw, int lh, const char *ll):
...
//
template <class ImagePixelType, class OverlayPixelType>
void GLSliceView<ImagePixelType, OverlayPixelType>::SetInputImage(ImageType * newImData)
{
    ...
    for( unsigned int ii=0; ii<this->cDimSize[0]; ii++ ) {
        ...
        for(unsigned int jj=0; jj<this->cDimSize[1]; jj++ ) {
            ...
            for( unsigned int kk=0; kk<this->cDimSize[2]; kk++ ) {
                ...
                this->cDataMax = this->cDataMax > tf ? this->cDataMax : tf ;
                this->cDataMin = this->cDataMin < tf ? this->cDataMin : tf;
            }
        }
    }
    ...
    this->cWinSizeX = std::max(this->cDimSize[0], std::max(this->cDimSize[1], this->cDimSize[2]));
    ...
    try {
        ...
        std::cerr << "Exception std::bad_alloc happened in GLSliceView::SetInputImage." << std::endl;
        throw;
    }
...
//
template <class ImagePixelType, class OverlayPixelType>
const typename GLSliceView<ImagePixelType,OverlayPixelType>::ImagePointer &GLSliceView<ImagePixelType, OverlayPixelType>::GetInputImage(void) const
{
    return this->cImData;
}
...
//
template <class ImagePixelType, class OverlayPixelType>
void GLSliceView<ImagePixelType, OverlayPixelType>::SetInputOverlay( OverlayType * newOverlayData )
{
    ...
    if( this->cValidImData
        ...
        if(!this->cValidImData) {
            std::cerr << "GLSliceView::SetInputOverlay Please set the input image before overlay"
                      << std::endl;
            std::cerr << "GLSliceView::SetInputOverlay Overlay not set." << std::endl;
        } else if((newoverlay_size[0] != this->cDimSize[0])
                  ||  (newoverlay_size[1] != this->cDimSize[1])
                  ||  (newoverlay_size[2] != this->cDimSize[2])
                 ) {
            std::cerr << "GLSliceView::SetInputOverlay Error: overlay and input images should be the same size"
                      << std::endl;
            std::cerr << "GLSliceView::SetInputOverlay Overlay not set." << std::endl;
        }
...
template <class ImagePixelType, class OverlayPixelType>
const typename GLSliceView<ImagePixelType, OverlayPixelType>::OverlayPointer & GLSliceView<ImagePixelType, OverlayPixelType>::GetInputOverlay( void ) const
{
...
//
template <class ImagePixelType, class OverlayPixelType>
void GLSliceView<ImagePixelType, OverlayPixelType>::ViewOverlayData( bool newViewOverlayData)
{
...
template <class ImagePixelType, class OverlayPixelType>
bool GLSliceView<ImagePixelType, OverlayPixelType>::ViewOverlayData(void)
{
...
template <class ImagePixelType, class OverlayPixelType>
void GLSliceView<ImagePixelType, OverlayPixelType>::ViewOverlayCallBack( void (* newViewOverlayCallBack)(void) )
{
...
template <class ImagePixelType, class OverlayPixelType>
void GLSliceView<ImagePixelType, OverlayPixelType>::ViewClickedPoints( bool newViewClickedPoints )
{
...
template <class ImagePixelType, class OverlayPixelType>
bool GLSliceView<ImagePixelType, OverlayPixelType>::ViewClickedPoints()
{
...
//
template <class ImagePixelType, class OverlayPixelType>
void GLSliceView<ImagePixelType, OverlayPixelType>::OverlayOpacity( float newOverlayOpacity )
{
...
template <class ImagePixelType, class OverlayPixelType>
float GLSliceView<ImagePixelType, OverlayPixelType>::OverlayOpacity(void)
{
...
//
template <class ImagePixelType, class OverlayPixelType>
typename GLSliceView<ImagePixelType, OverlayPixelType>::ColorTablePointer GLSliceView<ImagePixelType, OverlayPixelType>::GetColorTable(void)
{
...
//
template <class ImagePixelType, class OverlayPixelType>
void GLSliceView<ImagePixelType, OverlayPixelType>::SetColorTable(typename GLSliceView<ImagePixelType, OverlayPixelType>::ColorTablePointer newColorTable)
{
...
//
template <class ImagePixelType, class OverlayPixelType>
void GLSliceView<ImagePixelType, OverlayPixelType>::update()
{
    ...
    for(int k=startK; k <= this->cWinMaxY; k++) {
        ...
        for(int j=startJ; j <= this->cWinMaxX; j++) {
            ...
            default:
            case IMG_VAL:
				tf = (float)(255 * (this->cImData->GetPixel(ind) - this->cIWMin)
                             / (this->cIWMax - this->cIWMin));
                break;
            case IMG_INV:
...
template <class ImagePixelType, class OverlayPixelType>
void GLSliceView<ImagePixelType, OverlayPixelType>::clickSelect(float lx, float ly, float lz)
{
...
template <class ImagePixelType, class OverlayPixelType>
void GLSliceView<ImagePixelType, OverlayPixelType>::resize(int lx, int ly, int lw, int lh)
{
